...
public class frm_KhachHang extends frm_default implements ActionListener, MouseListener{
...
//        sortPanel.setBorder(BorderFactory.createTitledBorder("Sắp xếp danh sách khách hàng"));
		sortPanel.setBorder(BorderFactory.createTitledBorder(
	            BorderFactory.createLineBorder(new Color(163, 184, 204),2),"Sắp xếp danh sách khách hàng"));
